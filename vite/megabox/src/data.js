...
export const datas = [
    ...
    },
    {
      rank: 2,
        ...
        age:"15",
        like: 1300,
        description: "2002년 12월, 운명을 건 최후의 전쟁이 시작된다!<br>9명의 반지원정대는 사우론의 사악한 세력에 맞서 반지를 지켜냈지만 반지 원정대는 뿔뿔이 흩어지게 된다.<br>호빗족으로 절대 반지에 유일한 내성을 보이는 '프로도'는 일행",
        score: 9.7
    },
    {
        rank: 3,
        ...
        age: "15",
        like: 142,
        description: "&quot;나 오늘 거기 털고 옷 벗는다&quot;<br><br>공들인 작전 실패로 강등당한 후 열정도, 의지도, 수사 감각도 모두 잃은 형사 오남혁.<br>이제 그가 바라는 것은 오로지 한탕과 은퇴뿐.",
        score: 8.5
    },
    {
        rank: 4,
