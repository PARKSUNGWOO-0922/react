 ...
 * 2.정적(static) 필드,값 수정 가능
 * 3.파이널(final) 필드, 최종값으로 수정불가-> 상수(constant)를 저장하는 변수
 */
public class Korean {
	//1.필드선언시 초기화
	//타입 필드명 = 초깃값;
	...
	Korean(String nation, String ssn) {
		//this.필드명 = 매개변수명
		//this.nation = nation;//The final field Korean.nation cannot be assigned
		this.name = nation;
		//2.생성자 선언시 초기화
		this.ssn = ssn;
	}
