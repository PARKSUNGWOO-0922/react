...
public class CalculatorMain {
	...
	public static void main(String[] args) {
		...
		//참고 : 인스턴스 멤버 사용!
		//Cannot make a static reference to the non-static field Calculator.color
		//System.out.println(Calculator.color);
		System.out.println(myCal.color);//null
		//Cannot make a static reference to the non-static method setColor(String) from the type Calculator
		//Calculator.setColor("주황색");
		myCal.setColor("주황색");
		System.out.println(myCal.color);//주황색
